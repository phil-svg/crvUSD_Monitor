...
export function generateDefiSaverUrl(address, collateralName) {
    if (collateralName === 'WETH')
        collateralName = 'ETH';
...
//# sourceMappingURL=DefiSaver.js.map