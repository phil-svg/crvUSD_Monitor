export const ABI_priceAggregator = [
    {
        name: "AddPricePair",
        inputs: [
    ...
    { stateMutability: "nonpayable", type: "function", name: "add_price_pair", inputs: [{ name: "_pool", type: "address" }], outputs: [] },
    { stateMutability: "nonpayable", type: "function", name: "remove_price_pair", inputs: [{ name: "n", type: "uint256" }], outputs: [] },
...
//# sourceMappingURL=ABI_PriceAggregator.js.map