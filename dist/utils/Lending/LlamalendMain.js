...
import { enrichMarketData, handleEvent } from "./Helper.js";
async function processLlamalendVaultEvent(market, llamalendVaultContract, controllerContract, event, eventEmitter) {
...
// Markets: (v2)
const llamalendFactoryAddress = "0x34024bA3b6EdaF5cdd1C24FeFe1DF5D03041F38C"; // v2
// todo
