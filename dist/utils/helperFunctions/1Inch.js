...
const abiSwap1Inch = [
    ...
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: 'address', name: 'smartVault', type: 'address' }],
        name: 'SmartVaultSet',
        type: 'event',
    },
    {
    ...
    {
        inputs: [{ internalType: 'address', name: 'newSmartVault', type: 'address' }],
        name: 'setSmartVault',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    },
    {
        inputs: [],
        name: 'smartVault',
        outputs: [{ internalType: 'contract ISmartVault', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
...
export async function decode1Inch(tx) {
...
export async function decode1InchV5(tx) {
    // get method signature from input data
    const methodSignature = tx.input.slice(0, 10);
    console.log('tx', tx);
    // find corresponding method in abi
...
export async function getSwap1InchMinAmountInfo(txHash) {
...
export async function get1InchV5MinAmountInfo(txHash) {
    const tx = await getTxWithLimiter(txHash);
