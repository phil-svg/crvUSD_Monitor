...
async function getPositionHealthOfGeneralAddress(
  controllerAddress: string,
  userAddress: string,
  blockNumber: number
...
async function getCrvUsdTranserAmount(event: any, controllerAddress: string) {
  ...
  let amountElement = amounts.find(
    (element: any) =>
      element.returnValues.sender === event.returnValues.liquidator &&
...
export async function processLiquidateEvent(
  event: any,
  controllerAddress: string,
  collateralAddress: string,
  AMM_ADDRESS: string
...
export async function processRemoveCollateralEvent(
  event: any,
  controllerAddress: string,
  collateralAddress: string,
  AMM_ADDRESS: string
...
export async function processRepayEvent(
  event: any,
  controllerAddress: string,
  collateralAddress: string,
  AMM_ADDRESS: string
...
export async function processBorrowEvent(
  event: any,
  controllerAddress: string,
  collateralAddress: string,
  AMM_ADDRESS: string
...
export async function processTokenExchangeEvent(
  event: any,
  controllerAddress: string,
  collateralAddress: string,
  AMM_ADDRESS: string
