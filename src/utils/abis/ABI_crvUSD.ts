...
export const ABI_crvUSD: AbiItem[] = [
  {
    name: "Approval",
    inputs: [
  ...
  { stateMutability: "nonpayable", type: "function", name: "burn", inputs: [{ name: "_value", type: "uint256" }], outputs: [{ name: "", type: "bool" }] },
  {
    stateMutability: "nonpayable",
    type: "function",
    name: "mint",
  ...
  { stateMutability: "nonpayable", type: "function", name: "set_minter", inputs: [{ name: "_minter", type: "address" }], outputs: [] },
